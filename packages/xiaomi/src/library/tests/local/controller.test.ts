...
import {MiotEndpointConnectionTransportUnavailableError} from '../../endpoint-connection/index.js';
import type {LocalCertificateManager} from '../../local/certificate.js';
import {
  LocalController,
  type LocalControllerDiscovery,
  type LocalControllerOptions,
} from '../../local/controller.js';
import type {CentralRoute} from '../../local/discovery.js';
import type {
  LocalDeviceInfo,
  LocalMqttClient,
